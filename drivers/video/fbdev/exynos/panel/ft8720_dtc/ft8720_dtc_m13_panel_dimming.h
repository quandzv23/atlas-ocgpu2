/*
 * linux/drivers/video/fbdev/exynos/panel/ft8720_dtc/ft8720_dtc_m13_panel_dimming.h
 *
...
#ifndef __FT8720_M13_PANEL_DIMMING_H___
#define __FT8720_M13_PANEL_DIMMING_H___
...
static unsigned int ft8720_dtc_m13_brt_tbl[FT8720_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int ft8720_dtc_m13_step_cnt_tbl[FT8720_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table ft8720_dtc_m13_panel_brightness_table = {
	.brt = ft8720_dtc_m13_brt_tbl,
	.sz_brt = ARRAY_SIZE(ft8720_dtc_m13_brt_tbl),
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = ft8720_dtc_m13_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(ft8720_dtc_m13_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info ft8720_dtc_m13_panel_dimming_info = {
	.name = "ft8720_dtc_m13",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &ft8720_dtc_m13_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __FT8720_M13_PANEL_DIMMING_H___ */
